        ...
        <>
            <div className="w-full h-auto bg-gradient-to-b from-[#0f173b] to-[#1e293b] flex flex-col items-center py-5 overflow-hidden" >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 w-full md:w-[90%] mt-5 p-5 h-auto overflow-hidden">
                    ...
                    <motion.div {...scrollLeft} className="w-full md:w-85 mb-5 md:mb-0 h-90 md:h-85 p-5 rounded-md bg-[#0f172a] shadow-md cursor-pointer">
                    ...
                    <motion.div {...scrollLeft} className="w-full md:w-85 mb-5 md:mb-0 md:h-85 h-90 p-5 rounded-md bg-[#0f172a] shadow-md cursor-pointer">
