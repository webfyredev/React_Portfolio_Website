    ...
    return(
        <>
            <div className="w-full h-auto bg-gradient-to-b from-[#0f173b] to-[#1e293b] flex flex-col items-center py-5 overflow-hidden" id="skill">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-5 gap-3 mt-10 p-5 w-full md:w-auto h-auto overflow-hidden">
                    <motion.div {...scrollLeft}  className="w-85 mb-5 md:mb-0 h-85 p-5 rounded-md bg-[#0f172a] shadow-md cursor-pointer flex flex-col">
                    ...
                    <motion.div {...scrollLeft} className="w-85 mb-5 md:mb-0 h-85 p-5 rounded-md bg-[#0f172a] shadow-md cursor-pointer">
