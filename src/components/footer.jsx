        ...
        <>
            <footer className="w-full h-auto flex flex-col items-center justify-center bg-[#0f172a] py-5 overflow-hidden">
                ...
                <div className="flex w-full h-10 items-center justify-between px-5">
                    <p className="text-[#64748b] text-[10px] md:text-sm">&copy; {dates} <Link to="mailto:webfyre@gmail.com" className="font-semibold hover:text-[#2563eb] transition-all">webfyre@gmail.com</Link>. All right reserved.</p>
